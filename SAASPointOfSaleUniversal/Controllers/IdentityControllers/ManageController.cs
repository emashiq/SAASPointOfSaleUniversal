...
using WebApp.Identity.ManageViewModels;
...
namespace WebApp.Controllers
{
    public class ManageController : AccountController
    {
        ...
        public ManageController(RoleManager<MongoRole> _roleManager, UserManager<ApplicationUser> _UserManager, SignInManager<ApplicationUser> _SignInManager)
            : base(_roleManager, _UserManager, _SignInManager)
        {
        ...
        public async Task<IActionResult> EnableAuthenticator(EnableAuthenticatorViewModel model)
        {
            ...
            System.Collections.Generic.IEnumerable<string> recoveryCodes = await UserManager.GenerateNewTwoFactorRecoveryCodesAsync(user, 10);
